...
if(isset($_POST["Submit"])){
  ...
  if(empty($Category)){
    ...
    global $ConnectingDB;
    $sql = "INSERT INTO Category(Category,Created_By,Datetime,Cat_Description)";
    $sql .= "VALUES(:categoryName,:adminName,:dateTime,:desc)";
          ...
          <div class="card-body bg-dark">
            <div class="form-group">
              <label for="title"> <span class="FieldInfo"> Category Title: </span></label>
               <input class="form-control" type="text" name="CategoryTitle" id="title" placeholder="Please Enter the Name of the Category" value="">
