...
if(isset($_POST["Submit"])){
  ...
  if(empty($Username)){
    ...
    global $ConnectingDB;
    $sql = "INSERT INTO Staff(Name,Username,Added_By)";
    $sql .= "VALUES(:username,:name,:adminName)";
          ...
          <div class="card-body bg-dark">
            <div class="form-group">
              <label for="Username"> <span class="FieldInfo"> Username: </span></label>
               <input class="form-control" type="text" name="Username" id="Username" placeholder="Please Enter the Name of the Category" value="">
          
              
                 
            <div class="form-group">
              <label for="Name"> <span class="FieldInfo"> Name: </span></label>
               <input class="form-control" type="text" name="Name" id="Name" placeholder="Please Enter the Description of the Category" value="">
                      </div>
            </div>
            <div class="row">
