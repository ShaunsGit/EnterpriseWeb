...
if(isset($_POST["Submit"])){
  ...
  if(empty($Name)||empty($Email)||empty($Comment)){
    ...
    global $ConnectingDB;
    $sql  = "INSERT INTO Comments(Date_Posted,Name,Email,Text,approvedby,status,PostID)";
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
      <div class="row mt-4">
        <!-- Main Area Start-->
        <div class="col-sm-8 ">
          <h1>GucciGang Enterprise</h1>
          <h1 class="lead">Rolebase Idea Management System</h1>
          <?php
           echo ErrorMessage();
           echo SuccessMessage();
           ?>
...
WHERE PostID= '$PostIdFromURL'";
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <small class="text-muted"> <p>Department:   <td><span class="badge badge-success"><?php echo htmlentities($Dept); ?></span>
               ...
               & Written by:   <td><span class="badge badge-success"><?php echo htmlentities($Name); ?></span>
                  
                  
             
                  
                  
                  On <span class="text-dark"><?php echo htmlentities($Date); ?>
                  </span></small>
                <br>
        ...
        $sql  = "SELECT * FROM Comments
         WHERE PostID='$SearchQueryParameter'";
        $stmt =$ConnectingDB->query($sql);
        while ($DataRows = $stmt->fetch()) {
          $CommentDate   = $DataRows['Date_Posted'];
  ...
  <?php } ?>
        ...
        <div class="col-sm-4">
          <div class="card mt-4">
            <div class="card-body">
              <img src="images/tour.png" class="d-block img-fluid mb-3" alt="">
